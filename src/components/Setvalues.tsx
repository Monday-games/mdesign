...
const Setvalues: FunctionComponent<SetvaluesType> = ({ className = "" }) => {
  return (
    <div className={[styles.setvalues, className].join(" ")}>
      ...
      <div className={styles.actionButtonRows}>
            ...
            <div className={styles.outInputFields}>
              <div className={styles.run1Group}>
                <img
                  ...
                  src="/2run-1.svg"
                />
                <div className={styles.runOutType}>
      ...
      <div className={styles.actionButtonRows1}>
      ...
      <div className={styles.actionButtonRows2}>
      ...
      <div className={styles.actionButtonRows3}>
      ...
      <div className={styles.actionButtonRows4}>
              ...
              <div className={styles.cricketActionName}>
                <div className={styles.wideballParent}>
                  <img
                    ...
                    src="/wideball@2x.png"
                  />
                  <div className={styles.wideballScore}>
              ...
              <div className={styles.frameWrapper5}>
                <div className={styles.noballParent}>
                  <img
                    ...
                    src="/noball@2x.png"
                  />
                  <div className={styles.noballScore}>
      ...
      <div className={styles.actionButtonRows5}>
